            ...
            <div className="container mx-auto px-6">
                <div className="flex flex-col md:flex-row justify-between items-center mb-16 gap-8">
                    ...
                    <div className="flex gap-4">
                        <button
                            onClick={prevSlide}
                            className="w-12 h-12 border border-zinc-800 flex items-center justify-center rounded-full text-white hover:bg-yellow-600 hover:border-yellow-600 transition-all duration-300 group"
                        >
                        ...
                        >
                            <div className="max-w-4xl mx-auto">
                                <div className="bg-zinc-900 p-12 md:p-16 border border-zinc-800 relative shadow-2xl">
                                    <Quote className="absolute top-10 right-10 text-yellow-600/10" size={100} />

                                    <div className="space-y-8 relative z-10">
                                        {/* THE FIX: text-justify and w-full added here */}
                                        <p className="text-zinc-300 font-sans text-xl md:text-2xl leading-relaxed italic font-light text-justify w-full">
                                        ...
                                        <div className="pt-8 border-t border-zinc-800 flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
                                            <div>
                                                ...
                                                <span className="text-yellow-600 font-sans text-xs uppercase tracking-widest bg-yellow-600/5 px-3 py-1 rounded-full border border-yellow-600/10">
                                            ...
                                            <div className="flex gap-2">
                                                {testimonials.map((_, i) => (
                                                    <button
                                                        ...
                                                        className={`w-2 h-2 rounded-full transition-all duration-500 ${currentIndex === i ? "bg-yellow-600 w-8" : "bg-zinc-800"
                                                            }`}
                                                    />
                                                ))}
                                            </div>
